...
function chattingFunc (e, i) {
  ...
  if ( thisClassName == "user-a" ) {
   txt.push(`<div class="line char-a right"><div class="txt">${inputTxt}</div></div>`); // user-a 채팅창 입력될 내용
   txt.push(`<div class="line char-a"><div class="txt">${inputTxt}</div></div>`); // user-b 채팅창 입력될 내용
   txt.push(`<div class="line char-a"><div class="txt">${inputTxt}</div></div>`); // user-c 채팅창 입력될 내용
