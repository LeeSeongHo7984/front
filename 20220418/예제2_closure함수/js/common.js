...
function outFunc () {
  ...
  return innerFunc; // 내부함수를 return을 통하여 외부로 노출 closure: 이 경우 외부에서 매개변수를 받을 수 있다.
}
...
// 중첩함수
// 변수선언 이름과 동일한 함수명을 사용 할 수 없다. 변수로 사용된다.
// 중첩함수는 외부에서 내부함수를 호출할 수 없다. 내부에서만 호출이 가능.
//
// 클로저(폐쇄)
// 1. 함수를 중첩으로 사용하여 외부와 단절 시킴
// 2.return을 사용하여 외부에 함수를 노출, 외부에서 매개변수 등을 통하여 내부함수에 접근 할 수 있다
